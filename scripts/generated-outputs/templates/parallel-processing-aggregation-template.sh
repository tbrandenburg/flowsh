...
# Parallel Processing with Aggregation - Scalable Data Processing - Generated by flowsh
# Registry-based workflow execution script

echo "Starting workflow: Parallel Processing with Aggregation - Scalable Data Processing"
...
# Node: initialize_parallel_system
...
# Node: generate_processing_report

# Node: generate_processing_report (Generate Comprehensive Processing Report)
execute_template_transform_generate_processing_report() {
    log_step "🔧 Template Transform: Generate Comprehensive Processing Report"
...
# Advanced template function processor for node generate_processing_report
process_template_functions_generate_processing_report() {
    local content="$1"
...
process_template_functions() {
    process_template_functions_generate_processing_report "$1"
}
execute_template_transform_generate_processing_report

# Node: send_processing_notification

# Node: send_processing_notification (Send Processing Completion Notification)
execute_telegram_send_processing_notification() {
    log_step "📱 Sending Telegram message: Send Processing Completion Notification"

    local message="⚡ Parallel Processing & Aggregation Complete!

📊 **Processing Summary:**
- ID: {{initialize_parallel_system.output}}
- Workers: $(get_var "PARALLEL_WORKERS" "send_processing_notification")
- Sources: $(get_var "INPUT_DATA_SOURCES" "send_processing_notification")
- Method: $(get_var "AGGREGATION_METHOD" "send_processing_notification")

🎯 **Performance Results:**
{{collect_worker_results.output}}

🔄 **Aggregation Status:**
{{aggregate_results.output}}

📈 **Optimization Level:**
$(get_var "PERFORMANCE_OPTIMIZATION" "send_processing_notification") optimizations applied

✅ High-performance parallel processing completed successfully!
"
    ...
    local chat_id="$(get_var "TELEGRAM_CHAT_ID" "send_processing_notification")"

    # Use bot_token from node configuration
    local bot_token="$(get_var "TELEGRAM_BOT_TOKEN" "send_processing_notification")"
