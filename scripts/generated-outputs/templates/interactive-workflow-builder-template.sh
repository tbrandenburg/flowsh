...
# Interactive Workflow Builder - Meta-Workflow Composition - Generated by flowsh
# Registry-based workflow execution script

echo "Starting workflow: Interactive Workflow Builder - Meta-Workflow Composition"
...
# Node: create_deployment_guide (Create Deployment Guide)
execute_template_transform_create_deployment_guide() {
    log_step "🔧 Template Transform: Create Deployment Guide"
...
# Advanced template function processor for node create_deployment_guide
process_template_functions_create_deployment_guide() {
    local content="$1"
...
process_template_functions() {
    process_template_functions_create_deployment_guide "$1"
}
execute_template_transform_create_deployment_guide

# Node: send_notification

# Node: send_notification (Send Success Notification)
execute_telegram_send_notification() {
    log_step "📱 Sending Telegram message: Send Success Notification"

    local message="🎉 Interactive Workflow Builder - Success!

✅ Generated workflow for: $(get_var "USER_REQUIREMENTS" "send_notification")
📊 Pattern: {{select_pattern.output}}
🔧 Complexity: $(get_var "TARGET_COMPLEXITY" "send_notification")
...
"
    ...
    local chat_id="$(get_var "TELEGRAM_CHAT_ID" "send_notification")"

    # Use bot_token from node configuration
    local bot_token="$(get_var "TELEGRAM_BOT_TOKEN" "send_notification")"
