...
(
CONV_ID="$(get_var "CONV_ID" "initialize_memory_system")"
...
(
CONV_ID="$(get_var "CONV_ID" "load_conversation_history")"
/bin/bash -c "set -euo pipefail
...
(
USER_INPUT="$(get_var "USER_INPUT" "save_conversation_turn")"
LLM_CONTENT="$(get_var "LLM_CONTENT" "save_conversation_turn")"
CONV_ID="$(get_var "CONV_ID" "save_conversation_turn")"
HISTORY_FILE="$(get_var "HISTORY_FILE" "save_conversation_turn")"
/bin/bash -c "set -euo pipefail
...
(
CONV_ID="$(get_var "CONV_ID" "update_context_summary")"
USER_INPUT="$(get_var "USER_INPUT" "update_context_summary")"
LLM_CONTENT="$(get_var "LLM_CONTENT" "update_context_summary")"
CONTEXT_FILE="$(get_var "CONTEXT_FILE" "update_context_summary")"
/bin/bash -c "set -euo pipefail
